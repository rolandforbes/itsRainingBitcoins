...
open class DefaultAPI {
  ...
  "maritalStatus" : "maritalStatus"
    ...
    /**
     ...
     - parameter lon: (query)  (optional)
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func weatherdata1Get(appid: String? = nil, lat: String? = nil, q: String? = nil, lon: String? = nil, completion: @escaping ((_ data: Weather?,_ error: Error?) -> Void)) {
        weatherdata1GetWithRequestBuilder(appid: appid, lat: lat, q: q, lon: lon).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "weather" : [ {
     ...
     */
    open class func weatherdata1GetWithRequestBuilder(appid: String? = nil, lat: String? = nil, q: String? = nil, lon: String? = nil) -> RequestBuilder<Weather> {
